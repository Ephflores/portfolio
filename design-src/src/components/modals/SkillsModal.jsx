  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative bg-slate-800/30 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 min-h-[300px] overflow-hidden">
        ...
        {/* Lava-lamp style animated blobs (subtle and relaxing) */}
        ...
        <div className="flex flex-wrap gap-3 justify-center relative z-10">
          {skills[activeCategory].map((skill, index) => (
            <Badge
              key={index}
              className="px-4 py-2 text-base bg-slate-800 text-gray-300 border-slate-600 hover:bg-gradient-to-r hover:from-cyan-500/20 hover:to-blue-500/20 hover:border-cyan-500/50 hover:text-white transition-all duration-300 cursor-default"
